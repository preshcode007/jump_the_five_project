...
def test_03():
    ...
    rv, out = getstatusoutput(f'python3 {prg} "That number to call is 098-765-4321." --strings')
    assert rv == 0

    assert out.strip() == 'That number to call is zero-nine-eight-seven-six-five-four-three-two-one.'